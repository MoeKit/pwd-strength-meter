...
pwdStrengthMeter.prototype.setProgressBar = function ($el, score) {
    ...
    if (score < options.scores[0]) {
        ...
        if (options.showVerdicts) {
            $verdict.show().text(options.verdicts[0]);
        }
        ...
        if (options.showVerdicts) {
            $verdict.show().text(options.verdicts[1]);
        }
        ...
        if (options.showVerdicts) {
            $verdict.show().text(options.verdicts[2]);
        }
        ...
        if (options.showVerdicts) {
            $verdict.show().text(options.verdicts[3]);
        }
        ...
        if (options.showVerdicts) {
            $verdict.show().text(options.verdicts[4]);
        }
    }
};
